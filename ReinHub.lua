...
local Window = OrionLib:MakeWindow({Name = "LHH HUB", HidePremium = false, IntroText = "REINHUB Library", SaveConfig = true, ConfigFolder = "LHH HUB"})
...
OrionLib:MakeNotification({
	Name = "LHH HUB",
	Content = "LHH HUB Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By REIN")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] LHH HUB is back!")
